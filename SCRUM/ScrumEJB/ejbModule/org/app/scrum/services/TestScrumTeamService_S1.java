...
public class TestScrumTeamService_S1 {
	...
	public static void main() throws Exception{
		...
		Team echipaS1 = new Team(1, Team.Specializare.BACKEND);
		List<Member> membri = new ArrayList<>();
		membri.add(new Member(1, "M1S1", "uml architect"));
		membri.add(new Member(2, "M2S1", "java developer"));
		membri.add(new Member(3, "M3S1", "java developer"));
		echipaS1.setMembri(membri);
		
		// cerinte
		List<Feature> cerinteS1 = new ArrayList<>();
		cerinteS1.add(new Feature(1, "Design arhitectura model business"));
		cerinteS1.add(new Feature(2, "Implementare model business in Java"));
		sprintS1.setCerinte(cerinteS1);
		
		// taskuri pentru prima cerinta
		Feature cerinta = sprintS1.getCerinte().get(0);
		...
		for(Feature c: sprintS1.getCerinte()){
